            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-gray-700 mb-3">Datenerfassung auf dieser Website</h3>
                        ...
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">5. Plugins und Tools</h2>

                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-gray-700 mb-3">Google Fonts (lokales Hosting)</h3>
                            <p className="text-gray-600">
                        ...
                        <div className="mb-8">
                            <p className="text-gray-600">
                                Diese Datenschutzerklärung wurde mit dem Datenschutzerklärungs-Generator der
                                eRecht24 erstellt.
                            </p>
                        </div>
                        ...
                        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mt-8">
                            <p className="text-blue-800">
                                <strong>Stand dieser Datenschutzerklärung:</strong> Januar 2024<br />
