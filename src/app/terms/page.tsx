        ...
        <div className="min-h-screen theme-bg py-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="theme-bg-card rounded-lg p-8">
                    <h1 className="text-3xl font-bold theme-text mb-8">Terms and Conditions</h1>

                    <div className="prose prose-lg max-w-none">
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 1 Scope of Application</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 2 Service Offerings</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 3 Contract Formation</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 4 Service Provision</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 5 Remuneration and Payment</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 6 Warranty</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 7 Liability</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 8 Data Protection</h2>
                        ...
                        <h2 className="text-2xl font-semibold theme-text mb-4">§ 9 Final Provisions</h2>
