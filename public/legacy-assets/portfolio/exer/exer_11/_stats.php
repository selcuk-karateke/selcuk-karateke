...
<table class="table table-hover table-striped table-condensed">
	...
	<tr>
		<td style="width:200px;">Speichernutzung:</td>
		<td><?php echo convert(memory_get_usage(true)); ?></td>
	</tr>
	<tr>
		<td>Speicher Höchstwert:</td>
		<td><?php echo convert(memory_get_peak_usage(true)); ?></td>
	</tr>
	<tr>
		<td>Freier HDD Speicher:</td>
		<td><?php echo $sum1." (".$p.")"; ?></td>
	</tr>
	<tr>
		<td>Gesamt HDD Speicher:</td>
		<td><?php echo $sum2; ?></td>
	</tr>
	<tr>
...
<table class="table table-hover table-condensed table-striped">
	...
	<tr>
		...
		<td><!--?php echo $db->getAttribute(constant("PDO::ATTR_SERVER_VERSION")); ?--></td>
	</tr>
	<tr>
		<td style="width:200px;">PHP:</td>
	...
	<tr>
		...
		<td><?php echo php_short_tag(); ?></td>
	</tr>
	<tr>
		<td>Safe Mode:</td>
		<td><?php echo php_safe_mode(); ?></td>
	</tr>
	<tr>
		<td>Memory Limit:</td>
	...
	<tr>
		...
		<td><?php echo php_max_execution_time(); ?></td>
	</tr>
	<tr>
		<td>Upload Max Filesize:</td>
		<td><?php echo php_max_upload_size(); ?></td>
	</tr>
	<tr>
		<td>Post Max Size:</td>
		<td><?php echo php_max_post_size(); ?></td>
	</tr>
</table>
<table class="table table-hover table-condensed table-striped">
<thead>
...
foreach(get_loaded_extensions() as $i => $ext){
   echo "<tr><td>".$ext."</td><td>".phpversion($ext)."</td></tr>";
}
?>
<tr>
	<th>Apache Module:</th>
...
foreach(apache_get_modules() as $value){
   echo "<tr><td>Module</td><td>".$value."</td></tr>";
}
?>
</table>